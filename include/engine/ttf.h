...
#endif
/* Create a string */
AmphoraString *Amphora_CreateString(AmphoraString **msg, const char *font_name, int pt, float x, float y, int order, SDL_Color color, const char *text, bool stationary);
