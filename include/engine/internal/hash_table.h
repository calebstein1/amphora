...
#define Amphora_HTCheckValueExists(k, type, t) Amphora_HTGetValuePtr((k), (t), (sizeof((t)) / sizeof(*(t))))
...
void *Amphora_HTGetValuePtr(const char *key, const HT_HashTable *t, size_t len);
Uint32 Amphora_HTSetValuePtr(const char *key, Uint64 val, size_t nbytes, HT_HashTable *t, size_t len);
